...
class Settings:
    ...
    postgres_db: str = os.getenv("POSTGRES_DB", "img2svg")
    postgres_user: str = os.getenv("POSTGRES_USER", "img2svg")
    postgres_password: str = os.getenv("POSTGRES_PASSWORD", "img2svg")
    postgres_host: str = os.getenv("POSTGRES_HOST", "postgres")
    postgres_port: int = int(os.getenv("POSTGRES_PORT", "5432"))
    redis_url: str = os.getenv("REDIS_URL", "redis://redis:6379/0")
    rq_queue: str = os.getenv("RQ_QUEUE", "img2svg")
    s3_endpoint: str = os.getenv("S3_ENDPOINT", "http://minio:9000")
    s3_region: str = os.getenv("S3_REGION", "us-east-1")
    s3_bucket: str = os.getenv("S3_BUCKET", "img2svg")
